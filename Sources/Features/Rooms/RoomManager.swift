...
s; ; ; ; truct Room: Codable, Identifiable {
 ; ; ; ; let id: String
 ; ; ; ; var name: String
 ; ; ; ; var icon: String?
...
f; ; ; ; inal class RoomManager: RoomManaging {
...
e; ; ; ; num RoomError: LocalizedError {
 ; ; ; ; case notFound
 ; ; ; ; case deviceNotFound
