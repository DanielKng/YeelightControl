...
e; num FlowPreset: String, CaseIterable {
c; ase candlelight = "Candlelight"
c; ase sunrise = "Sunrise"
c; ase disco = "Disco"
c; ase pulse = "Pulse"
c; ase strobe = "Strobe"

v; ar params: YeelightDevice.FlowParams {
s; witch self {
case .candlelight:
r; eturn YeelightDevice.FlowParams(
count: 0,
action: .recover,
transitions: [
...
i; f let index = editingColorIndex {
...
e; num ColorMode {
c; ase rgb, temperature, brightness
}
...
p; rivate func updateTransition() {
transition.duration = duration

s; witch mode {
case .rgb:
l; et components = UIColor(selectedColor).cgColor.components ?? [1, 1, 1, 1]
