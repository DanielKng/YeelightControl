...
s; truct HelpView: View {
@Environment(\.dismiss); ; private var dismiss
@; ; State private; ; var selectedTopic: HelpTopic?
@; ; State private; ; var searchText = ""

e; num HelpTopic: String, CaseIterable {
c; ase gettingStarted = "; ; Getting Started"
c; ase basicControls = "; ; Basic Controls"
c; ase scenes = "Scenes"
c; ase advanced = "Advanced"
...
s; truct HelpSection: Identifiable {
l; et id = UUID()
l; et title: String
l; et content: String
l; et steps: [String]
...
i; f section.id != topic.content.last?.id {
Divider()
.padding(.horizontal)
}
}
