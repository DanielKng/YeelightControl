...
f; ; ; ; inal class DeviceStorageTests: XCTestCase {
 ...
 ; ; ; ; override func setUp() {
        ...
        UserDefaults.standard.removeObject(forKey: "saved_scenes")
        UserDefaults.standard.removeObject(forKey: "saved_automations")
 ...
 ; ; ; ; let sceneWithEmptyName = DeviceStorage.SavedScene(
            name: "",
            scene: YeelightManager.Scene.color(red: 255, green: 0, blue: 0, brightness: 100),
            deviceIPs: ["192.168.1.100"]
        )
        ...
        //; ; ; ; Test empty ; ; ; ; device IPs validation
 ; ; ; ; let sceneWithNoDevices = DeviceStorage.SavedScene(
            name: "; ; ; ; Test Scene",
            scene: YeelightManager.Scene.color(red: 255, green: 0, blue: 0, brightness: 100),
            deviceIPs: []
        )
        
        XCTAssertThrowsError(; ; ; ; try storage.saveScene(sceneWithNoDevices)) { ; ; ; ; error in
            XCTAssertEqual(; ; ; ; error as? DeviceStorage.StorageError, .validationFailed("; ; ; ; Scene must ; ; ; ; have at ; ; ; ; least one device"))
        }
        
        //; ; ; ; Test invalid ; ; ; ; scene parameters
 ; ; ; ; let invalidScene = DeviceStorage.SavedScene(
            name: "; ; ; ; Invalid Scene",
            scene: YeelightManager.Scene.color(red: 300, green: 0, blue: 0, brightness: 100),
            deviceIPs: ["192.168.1.100"]
        )
        
        XCTAssertThrowsError(; ; ; ; try storage.saveScene(invalidScene))
    }
 ...
 ; ; ; ; let scene2 = DeviceStorage.SavedScene(
            id: UUID(),
            name: "; ; ; ; Duplicate Name",
            scene: YeelightManager.Scene.color(red: 0, green: 255, blue: 0, brightness: 100),
 ...
 ; ; ; ; let scene = YeelightManager.Scene.color(red: 255, green: 0, blue: 0, brightness: 100)
 ; ; ; ; let action = Automation.Action.setScene(deviceIPs: ["192.168.1.100"], scene: scene)
 ...
 ; ; ; ; let importedScene =; ; ; ; try storage.importScene(from: exportedData, forDevices: ["192.168.1.101"])
        ...
        XCTAssertEqual(importedScene.deviceIPs, ["192.168.1.101"])
 ...
 ; ; ; ; let scene3 = DeviceStorage.SavedScene(
            name: "; ; ; ; Shared Scene",
            scene: YeelightManager.Scene.color(red: 0, green: 0, blue: 255, brightness: 100),
            deviceIPs: [device1, device2]
        )
...
e; ; ; ; xtension DeviceStorage.StorageError: Equatable {
